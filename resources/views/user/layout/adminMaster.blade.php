...
<head>
    ...
    <meta name="description" content="Ordari admin template">
    <meta name="author" content="Hau Nguyen">
    <meta name="keywords" content="Ordari admin template">
        ...
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo">
                <a href="#" class="text-decoration-none">
                    <span class="h2 text-uppercase text-primary">Ordari Admin</span>
                </a>
            </div>
